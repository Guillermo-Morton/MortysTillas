...
botonContinuar.onclick = function(){
          ...
          if(valid){
            ...
            if(numeroPedidos === 1){
              ...
              window.open("https://api.whatsapp.com/send?phone=5493813198312&text=" + pedido1Item);
            } else if (numeroPedidos > 1){
              ...
              window.open("https://api.whatsapp.com/send?phone=5493813198312&text=" + pedido2Item);
            }
          }   
}
